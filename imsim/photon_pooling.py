...
def offset_photon_arrays(stamps, batch, offset_adjustment):
    """Take a batch of photon arrays and perform the sub-pixel offset needed to place
    the object correctly within the full image.
