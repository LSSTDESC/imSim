...
import numpy as np
from galsim.main import parse_args, make_logger, ReadConfig, process_config
...
def run_imsim(nfiles):
    ...
    all_config = [{'template': template,
                   ...
                   'output.truth.file_name.format':
                   'centroid_%08d-%1d-%s-%s-det%03d.txt'}]
    ...
    return process_config(all_config, args, logger)
